...
/**
 * @author Geert van Ieperen created on 18-2-2018.
 */
public final class MenuStyleSettings {
    ...
    public static final Color4f MENU_FILL_COLOR = Color4f.GREY;
    public static final Color4f MENU_STROKE_COLOR = BLACK;
    public static final Color4f SLIDER_FILL_COLOR = BLACK;
    public static final int MENU_STROKE_WIDTH = 2;
