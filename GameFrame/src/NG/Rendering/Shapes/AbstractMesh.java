...
/**
 * @author Geert van Ieperen. Created on 19-11-2018.
 */
public class AbstractMesh implements Mesh {
    /**
     * an empty mesh, not bound to any resources.
     */
    public static final AbstractMesh EMPTY_MESH = new EmptyMesh();
    protected static Queue<AbstractMesh> loadedMeshes = new ArrayDeque<>(20);
    private int vaoId;
     ...
     */
    public static Supplier<AbstractMesh> meshFromHeightmap(float[][] heightmap, int xStart, int xEnd, int yStart, int yEnd, float edgeSize) {
        ...
        return FlatMesh.createDelayed(vertices, normals, faces);
    }
     ...
     */
    protected void writeToGL(float[] positions, float[] normals) {
