...
public class ClickShader implements ShaderProgram {
    private static final Resource.Path CLICK_SHADER_PATH = SHADER_DIRECTORY.resolve("Click");
    private static final Resource.Path VERTEX_PATH = CLICK_SHADER_PATH.resolve("click.vert");
    private static final Resource.Path FRAGMENT_PATH = CLICK_SHADER_PATH.resolve("click.frag");
