...
public interface KeyMouseCallbacks {
    /**
     * @param listener when the mouse moves, the {@link MouseMoveListener#onMouseMove(int, int, float, float)} method is called
     */
    ...
    /**
     * Try to remove the given listener from all the listener types, except for mouse move listeners. Even if the
